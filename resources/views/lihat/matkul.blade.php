  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-md-4 text-center">
				<div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="50">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/daskomjar.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a href="/lihat/matkul/daskomjar">Dasar Komunikasi Dan Jaringan</a>
				...
				<div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="100">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/daskom.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/daskom">Dasar - Dasar Komputer</a>
				...
				<div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="150">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/kalkulus.png')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/kalkulus">Kalkulus</a>
				...
				<div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="200">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/pad.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/pad">Pemrograman Analisa Data</a>
                ...
                <div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="250">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/pbo.png')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/pbo">Pemrograman Berorientasi Obyek I</a>
                ...
                <div class="col mb-5"data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="300">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/agama.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/agama">Pendidikan agama</a>
                ...
                <div class="col mb-5" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="350">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/pancasila.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/pancasila">Pendidikan Pancasila</a>
                ...
                <div class="col mb-5"data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="400">
					<div class="card h-100">
						<img src="{{('../../img/logoMatkul/statistika.jpg')}}" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-text">
                                <a  href="/lihat/matkul/statistika">Statistika</a>
							</h5>
						</div>
					</div>
				</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 map-img" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="3000">
                        ...
                        <address class="md-margin-bottom-40">
                            ...
                            Web:
                            <a href="/" class="">Skuy-Replay.com</a>
                        </address>
