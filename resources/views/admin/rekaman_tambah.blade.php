            ...
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Rekaman Kuliah | Tambah Data</div>
                    </div>


                    <!-- Users -->
                    <div class="table-responsive-xl">
                        <form method="post" action="/rekaman/simpan">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control" placeholder="Judul Nya Apa ...">
                                @if($errors->has('judul'))
                                    <div class="text-danger">
                                        {{ $errors->first('judul')}}
                                    </div>
                            ...
                            <div class="form-group">
                                <label for="matkul">Mata Kuliah Anda : </label>
                                <select name="matkul" class="form-control" id="matkul" >
                                    <option value="">"Mata Kuliah Nya Apa Gan.."</option>
                                    <option value="Dasar Komunikasi Dan Jaringan">Dasar Komunikasi Dan Jaringan</option>
                                    <option value="Dasar Dasar Komputer">Dasar - Dasar Komputer</option>
                                    <option value="Kalkulus">Kalkulus</option>
                                    <option value="Pemrograman Analisa Data"> Pemrograman Analisa Data</option>
                                    <option value="Pemrograman Berorientasi Obyek I">Pemrograman Berorientasi Obyek I</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kelas" class="form-control" placeholder="Anda Kelas Apa ...">
                                @if($errors->has('kelas'))
                                    <div class="text-danger">
                                        {{ $errors->first('kelas')}}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="dosen" class="form-control" id="dosen">
                                    <option value="">"Dosen Nya Siapa Gan.."</option>
                                    <option value="Vitalis Ayu">Vitalis Ayu</option>
                                    <option value="Eko Hari Parmadi">Eko Hari Parmadi</option>
                                    <option value="Hari Suparwito S.J.">Hari Suparwito S.J.</option>
                                    <option value="Henricus Agung Hernawan">Henricus Agung Hernawan</option>
                                    <option value="Veronika Mbae">Veronika Mbae</option>
                                    <option value="Imma Indra Dewi Windajani">Imma Indra Dewi Windajani</option>
                                    <option value="Febi Sanjaya">Febi Sanjaya</option>
                                </select>
                                @if($errors->has('dosen'))
                                    <div class="text-danger">
                                        {{ $errors->first('dosen')}}
                            ...
                            <div class="form-group">
                                <label>Link :</label>
                                <input type="text" name="link" class="form-control" placeholder="LINK nya bre ...">
                                @if($errors->has('link'))
                                    <div class="text-danger">
                                        {{ $errors->first('link')}}
                                    </div>
